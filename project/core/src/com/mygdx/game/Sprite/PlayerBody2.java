...
public class PlayerBody2 extends Sprite {
    public World world;
    public Body b2body;
    private TextureRegion tankStand;

    public PlayerBody2(World world, FightModeScreen screen, int x, int y) {
        super(screen.getAtlas().findRegion("Spectre"));
        this.world = world;
        defineTank(x,y);
        tankStand=new TextureRegion(getTexture(),128,136,128,75);
